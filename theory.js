        ...
        <div class="sub-section-content" id="sub-section-0">
            <div class="lesson-audio">
                <div class="audio-player">
                    ...
                    <audio id="audio-0" preload="none"><source src="audio/01-kapitel-1.wav" type="audio/wav"></audio>
                </div>
                <span class="lesson-audio-label">🔊 Ascultă capitolul 1 — Hedda</span>
            </div>
        ...
        <div class="sub-section-content" id="sub-section-1">
            <div class="lesson-audio">
                <div class="audio-player">
                    ...
                    <audio id="audio-1" preload="none"><source src="audio/02-kapitel-2.wav" type="audio/wav"></audio>
                </div>
                <span class="lesson-audio-label">🔊 Ascultă capitolul 2 — Hedda</span>
            </div>
        ...
        <div class="sub-section-content" id="sub-section-2">
            <div class="lesson-audio">
                <div class="audio-player">
                    ...
                    <audio id="audio-2" preload="none"><source src="audio/03-kapitel-3.wav" type="audio/wav"></audio>
                </div>
                <span class="lesson-audio-label">🔊 Ascultă capitolul 3 — Hedda</span>
            </div>
        ...
        <div class="sub-section-content" id="sub-section-3">
            <div class="lesson-audio">
                <div class="audio-player">
                    ...
                    <audio id="audio-3" preload="none"><source src="audio/04-kapitel-4.wav" type="audio/wav"></audio>
                </div>
                <span class="lesson-audio-label">🔊 Ascultă capitolul 4 — Hedda</span>
            </div>
        ...
        <div class="sub-section-content" id="sub-section-4">
            <div class="lesson-audio">
                <div class="audio-player">
                    ...
                    <audio id="audio-4" preload="none"><source src="audio/05-kapitel-5.wav" type="audio/wav"></audio>
                </div>
                <span class="lesson-audio-label">🔊 Ascultă capitolul 5 — Hedda</span>
            </div>
        ...
        <div class="sub-section-content" id="sub-section-5">
            <div class="lesson-audio">
                <div class="audio-player">
                    ...
                    <audio id="audio-5" preload="none"><source src="audio/06-kapitel-6.wav" type="audio/wav"></audio>
                </div>
                <span class="lesson-audio-label">🔊 Ascultă capitolul 6 — Hedda</span>
            </div>
        ...
        <div class="sub-section-content" id="sub-section-6">
            <div class="lesson-audio">
                <div class="audio-player">
                    ...
                    <audio id="audio-6" preload="none"><source src="audio/07-vocabular.wav" type="audio/wav"></audio>
                </div>
                <span class="lesson-audio-label">🔊 Pronunție vocabular — Hedda</span>
            </div>
